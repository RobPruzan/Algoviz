...
const SideBar = () => {
  ...
  return (
    <div className=" h-full flex">
      <div className=" h-[85%] w-64 rounded-md border-2 border-2-secondary flex flex-col justify-start items-center">
        <div className="flex flex-col w-full h-4/5 items-center justify-start p-5">
          ...
          <ScrollArea className="h-[400px] w-full mt-4 rounded-md border-2 p-4">
            {circles.map((circle) => (
              <div
                className="bg-primary border-2 w-40 mt-2 border-2-secondary rounded-md p-3 flex items-center justify-center"
                key={circle.id}
              >
        ...
        <div className="flex flex-col w-full h-1/5 items-center justify-end p-5">
          <div className="w-full flex justify-between">
            <Button
              ...
              className="bg-secondary hover:bg-primary border-2 border-2-secondary w-2/5"
            >
